    ...
    return (
        <div id="features">
        <div className="max-w-7xl mx-screen w-screen px-6  md:px-12 xl:px-6">
        ...
        <h2 className="my-8 text-2xl font-bold  md:text-4xl">
            A technology-first approach to payments
            and finance
        </h2>
        </div>
        <div
        class="rounded-3xl mt-16 grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden border border-gray-100 text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4"
        >
        <div class="flex group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
